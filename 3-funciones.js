...
// 1.3 Crea una función llamada `esMayorDeEdad` que tome un número como parámetro y 
//devuelva `true` si es mayor de 18, o `false` en caso contrario.
...
// 2.2 Escribe una función llamada `saludarPersonalizado` que reciba dos parámetros: `nombre` y `apellido`. 
///La función debe devolver "Hola, [nombre] [apellido]".
    function saludarPersonalizado(nombre, apellido){
        console.log("Hola, " + [nombre] + [apellido]);
    }
    saludarPersonalizado('Aru ', 'Devaca.');

// 2.3 Crea una función llamada `calcularPotencia` que reciba dos parámetros: base y exponente. 
...
// 3.3 Crea una **function expression** llamada `esPar` que acepte un número como parámetro 
